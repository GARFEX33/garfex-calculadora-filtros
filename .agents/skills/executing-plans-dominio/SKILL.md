...
5. **Después de CADA tarea completada:**
   - Anunciar: "Estoy usando la skill finishing-a-development-branch para completar esta tarea de dominio."
...
Después de completar todas las tareas de dominio:

- Verificar que todas las tareas estén commiteadas
- Anunciar: "Trabajo de dominio completado. Todas las tareas fueron verificadas y commiteadas individualmente."
