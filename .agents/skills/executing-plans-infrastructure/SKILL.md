...
Después de completar todas las tareas de infraestructura y verificarlas:

- Anunciar: "Estoy usando la skill finishing-a-development-branch para completar este trabajo de infraestructura."
