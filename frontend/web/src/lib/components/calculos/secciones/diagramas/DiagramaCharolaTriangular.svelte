<script lang="ts">
	...
	// Conductor positions (cx relative to inner left wall, cy is vertical offset from floor)
	let posiciones = $derived(calcularPosicionesCharolaTriangular(paramsTriangular));
